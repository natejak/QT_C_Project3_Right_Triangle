...
// Loop ask as long as values are >0
    ...
    do {
      printf("Enter base of your trinagle (in meters): ");
    ...
    do {
      printf("Enter high of your trinagle (in meters): ");
  ...
  OUT_Area = 0.5 * USR_ENTRY_Base * USR_ENTRY_Height;
    ...
    printf("Provided base: %.2f m \nProvided height: %.2f m \nThe area of the triangle is: %.2f m^2", USR_ENTRY_Base, USR_ENTRY_Height, OUT_Area);
